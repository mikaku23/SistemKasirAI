...
class StockBatchUpdateRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'received_by' => $this->filled('received_by') ? (int) $this->input('received_by') : null,
    ...
    {
        $stockBatch = $this->route('stock_batch');
        $stockBatchId = $stockBatch instanceof StockBatches ? $stockBatch->id : $stockBatch;
        ...
        return [
            ...
            'batch_code' => ['nullable', 'string', 'max:120', Rule::unique('stock_batches', 'batch_code')->ignore($stockBatchId)],
    ...
    public function messages(): array
    {
        return [
            ...
            'batch_code.unique' => 'Batch code sudah digunakan.',
        ];
    }
