...
class TransactionController extends Controller
{
    ...
    {
        return view('admin.transactions.index', array_merge($this->transactionService->indexData(), [
            'menu' => 'transactions',
        ]));
    }
    ...
    {
        return view('admin.transactions.create', array_merge($this->transactionService->referenceData(), [
            'menu' => 'transactions',
        ]));
    }
    ...
    public function print(Transaction $transaction)
    {
        ...
        if (class_exists(PdfFacade::class)) {
            return PdfFacade::loadView('admin.transactions.print', [
