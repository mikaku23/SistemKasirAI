<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav" aria-label="Sidebar navigation">
        ...
        <div class="nav-group" data-group="set">
            ...
            <a href="{{ route('promo-settings.index') }}"
                class="nav-item {{ $menu == 'promo-settings' ? 'active' : '' }}">
            ...
            <a href="{{ route('discount-settings.index') }}"
                class="nav-item {{ $menu == 'discount-settings' ? 'active' : '' }}">
        ...
        <div class="nav-group" data-group="pos">
            ...
            <a href="{{ route('stock-batches.index') }}"
                class="nav-item {{ $menu == 'stock-batches' ? 'active' : '' }}">
                <i class="icon fa-solid fa-boxes-stacked" aria-hidden="true"></i><span>Stock Batches</span>
            </a>

            <a href="{{ route('stock-adjustments.index') }}"
                class="nav-item {{ $menu == 'stock-adjustments' ? 'active' : '' }}">
                <i class="icon fa-solid fa-pen-to-square" aria-hidden="true"></i><span>Stock Adjustments</span>
            </a>
        ...
        <div class="nav-group" data-group="log">
            ...
            <a href="{{ route('stock-movements.index') }}"
                class="nav-item {{ $menu == 'stock-movements' ? 'active' : '' }}">
            ...
            <a href="{{ route('activity-logs.index') }}"
                class="nav-item {{ $menu == 'activity-logs' ? 'active' : '' }}">
                <i class="icon fa-solid fa-clipboard-list" aria-hidden="true"></i><span>Activity Logs</span>
            </a>
