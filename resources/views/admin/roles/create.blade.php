...
<section class="page-card glass-card role-page">
    <div class="page-card__head">
        <div class="page-card__title">
            ...
            <h2>Create Role</h2>
            <p>Isi data role bertahap. Draft tersimpan di browser saat berpindah langkah.</p>
        </div>
        ...
        <div class="wizard-body">
            ...
            <section class="wizard-step" data-step="2">
                <div class="wizard-step__head">
                    ...
                    <p>Tambahkan deskripsi singkat dan status aktif role.</p>
                </div>
            ...
            <section class="wizard-step" data-step="3">
                ...
                <div class="review-grid">
                    ...
                    <div class="review-item">
                        <span>Slug</span>
                        <strong data-review-field="slug">{{ old('slug', '-') }}</strong>
                    </div>
