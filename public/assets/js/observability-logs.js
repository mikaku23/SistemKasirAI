document.addEventListener('DOMContentLoaded', () => {
  const periodSelect = document.querySelector('[data-observability-period]');
  const customBlocks = Array.from(document.querySelectorAll('[data-observability-custom-range]'));
